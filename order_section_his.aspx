<%@ Page Language="VB" AutoEventWireup="false" CodeFile="order_section_his.aspx.vb" Inherits="order_section_his" %>
...
<body>
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    <td align="center">
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2"
                            ...
                            EmptyDataText="No Records" OnRowCommand="GridView2_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="count_team" HeaderText="จำนวนงาน" ReadOnly="True" 
                                    SortExpression="count_team">
                                <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                            </Columns>
                        ...
                        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource4"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="remark" HeaderText="หมายเหตุ" SortExpression="remark" />
                                 <asp:BoundField DataField="order_section_detail" HeaderText="ข้อแนะนำ" SortExpression="order_section_detail" />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Deviec_SA_V1ConnectionString %>"
        SelectCommand="sa_order_section_his_sum" 
        ...
        <SelectParameters>
            ...
            <%--<asp:ControlParameter ControlID="DropDownList1" Name="P_order_id" PropertyName="SelectedValue"
                Type="Int32" />--%>
            <asp:ControlParameter ControlID="DropDownList1" Name="P_order_id" 
                PropertyName="SelectedValue" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:Deviec_SA_V1ConnectionString %>"
        SelectCommand="sa_order_section_his" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:SessionParameter Name="P_office" SessionField="UserOffice" Type="String" />
            <%--<asp:ControlParameter ControlID="DropDownList1" Name="P_order_id" PropertyName="SelectedValue"
                Type="Int32" />--%>
