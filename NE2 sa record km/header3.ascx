<%@ Control Language="VB" AutoEventWireup="false" CodeFile="header3.ascx.vb" Inherits="header3" %>
<style type="text/css">
    .style1
    {
        width: 180px;
        ...
        <div class="sitename">
            <h1>
                <a href="index.html" title="Go to Start page">บันทึกประวัติอุปกรณ์<span style="font-weight: normal;
                    font-size: 50%;">&nbsp;KM Version </span></a>
            </h1>
            <h2>
                ฝปบ.น.๓</h2>
        </div>
    ...
    <div class="header-bottom">
        ...
        <div class="nav2">
            ...
            <ul>
                ...
                <li><a href="#">Cattalog<!--[if IE 7]><!--></a><!--<![endif]--><!--[if lte IE 6]><table><tr>
                ...
                <li><a href="#">Location<!--[if IE 7]><!--></a><!--<![endif]--><!--[if lte IE 6]><table><tr>
                    ...
                    <ul>
                        ...
                        <li><a href="list_changed_location_location.aspx">ประวัติการย้ายสถานที่</a></li>
