...
#End Region
Partial Class me_pmce_list_detail
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not func.CheckUserPermissions_access("me_pmce_list_detail.aspx", Session("User_access")) Then
        ...
        'UserClass.CheckLogin(Page)
        'If Not func.CheckUserPermissions("me_pmce_list_detail.aspx", "S") Then
        '    Response.Write("<p>" + "You don't have permissions to access this page" + "<a href=""login.aspx"">&nbsp;" + "Back to login page" + "</a></p>")
        '    Response.End()
        'Else
        '    strConnString = "Server=172.30.203.155;Uid=sa;PASSWORD=1234;database=SA_System;Max Pool Size=400;Connect Timeout=600;"
    ...
    Protected Sub ViewData()
        ...
        End If
        dt.Clear()
        strSQL = "SELECT order_type,pmcm_id, order_region_detail, order_type_id FROM sa.View_me_order_type_list WHERE pmcm_id = @pmcm_id"
        ...
        If dt2.Rows.Count > 0 Then
            Me.Label10.Text = dt2.Rows(0)("order_type").ToString
            Me.Label11.Text = dt2.Rows(0)("order_region_detail").ToString
        End If
        DataBind_gridview1()
        DataBind_gridview2()
    End Sub
