...
Partial Class order_section_his
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        UserClass.CheckLogin(Page)
        If Not func.CheckUserPermissions_access("order_section_his.aspx", Session("User_access")) Then
        ...
        'UserClass.CheckLogin(Page)
        'If Not func.CheckUserPermissions("order_section_his.aspx", "S") Then
        '    Response.Write("<p>" + "You don't have permissions to access this page" + "<a href=""login.aspx"">&nbsp;" + "Back to login page" + "</a></p>")
        '    Response.End()
        'Else
        '    Dim UserLogin As UserClass = CType(Session("User"), UserClass)
    ...
    Protected Sub GridView3_RowCommand(ByVal source As Object, ByVal e As GridViewCommandEventArgs)
        ...
        If e.CommandName = "cmdEdit" Then
            ...
            sStartPageURL = "order_section_sum_detail.aspx?pmcm_id=" & Convert.ToString(dkKeys(0))
