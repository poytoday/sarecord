<%@ Page Language="VB" AutoEventWireup="false" CodeFile="user_select_detail_proprety.aspx.vb" Inherits="user_select_detail_proprety" %>
    ...
    <div class="page-container">
        ...
        <h3>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="dbname"
                ...
                OnRowCommand="GridView1_RowCommand" Width="99%" PageSize="20" EmptyDataText="No records found">
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Deviec_SA_V1ConnectionString %>"
                ...
                InsertCommand="INSERT INTO sa.[Setting_Property] ([dbname], [property], [detail], [type_frtu]) VALUES (@dbname, @property, @detail, @type_frtu)"
