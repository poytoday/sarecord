<%@ Page Language="VB" AutoEventWireup="false" CodeFile="order_section_sum_detail.aspx.vb" Inherits="order_section_sum_detail" %>
                ...
                <h3>
                    ...
                    <table width="99%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:LinkButton ID="LinkButton2" runat="server" ValidationGroup="A">Update</asp:LinkButton>
                                <br />
                        ...
                        <tr>
                            <td class="style17">
                                <asp:LinkButton ID="LinkButton3" runat="server" ValidationGroup="A">Back</asp:LinkButton>
                                <td>
                                    &nbsp;
                                </td>
                            </td>
