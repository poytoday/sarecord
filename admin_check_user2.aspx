<%@ Page Language="VB" AutoEventWireup="false" CodeFile="admin_check_user2.aspx.vb" Inherits="admin_check_user2" %>
            ...
            <ContentTemplate>
                ...
                <h3>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    CellPadding="2" ForeColor="Black" GridLines="None" DataKeyNames="user_access">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="user_access" HeaderText="user_access"
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Deviec_SA_V1ConnectionString %>"
                        SelectCommand="sa_admin_count_user2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="DropDownList1" Name="P_access" 
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Deviec_SA_V1ConnectionString %>"
                    ...
                    SelectCommand="sa_admin_user_list2" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="Label3" Name="P_access" PropertyName="Text" 
                            Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
