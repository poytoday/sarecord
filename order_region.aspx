<%@ Page Language="VB" AutoEventWireup="false" CodeFile="order_region.aspx.vb" Inherits="order_region" %>
                ...
                <h3>
                    ...
                    <table width="99%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TextBox1" runat="server" Height="129px" TextMode="MultiLine" Width="660px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="style17">
                                <asp:LinkButton ID="LinkButton2" runat="server" ValidationGroup="A">ยอมรับ</asp:LinkButton>
                                <td>
                                    &nbsp;
                                </td>
                            </td>
