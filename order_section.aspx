<%@ Page Language="VB" AutoEventWireup="false" CodeFile="order_section.aspx.vb" Inherits="order_section" %>
                ...
                <h3>
                    <table width="99%">
                        ...
                        <tr>
                            ...
                            <td class="auto-style4">
                                <asp:Label ID="Label7" runat="server" Text="Label" ForeColor="Blue"></asp:Label>
                            </td>
                        </tr>
                 ...
                 <Table>
                    ...
                    <table width="99%">
                        ...
                        <tr>
                            <td class="style17">
                                <asp:LinkButton ID="LinkButton1" runat="server" ValidationGroup="A">ยอมรับ</asp:LinkButton>
                                <td>
                                    &nbsp;
                                </td>
                            </td>
