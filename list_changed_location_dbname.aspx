<%@ Page Language="VB" AutoEventWireup="false" CodeFile="list_changed_location_dbname.aspx.vb" Inherits="list_changed_location_dbname" %>
       ...
       รายละเอียดการแก้ไขชื่ออุปกรณ์
        ...
        <table width="99%">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Deviec_SA_V1ConnectionString %>"
                ...
                <SelectParameters>
                    <asp:Parameter DefaultValue="device" Name="P_type" Type="String" />
