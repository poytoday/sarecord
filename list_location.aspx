<%@ Page Language="VB" AutoEventWireup="false" CodeFile="list_location.aspx.vb" Inherits="list_location" %>
    ...
    <div class="page-container">
        ...
        <h3>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Deviec_SA_V1ConnectionString %>"
                SelectCommand="sa_select_chang_location" 
