<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Report_damage_his.aspx.vb"
    Inherits="Report_damage_his" %>
            ...
            <div class="page-container">
                ...
                <h3>
                        ...
                        <tr>
                            ...
                            <td class="style7">
                                <asp:RadioButtonList ID="RadioButtonList2" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource5"
                                    DataTextField="Team" DataValueField="ID" RepeatColumns="6" RepeatDirection="Horizontal"
                                    Width="99%">
                                </asp:RadioButtonList>
                        ...
                        <tr>
                            ...
                            <td class="style7">
                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource2"
                                    DataTextField="type_frtu" DataValueField="ID" RepeatColumns="3" RepeatDirection="Horizontal"
                                    Width="99%">
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Deviec_SA_V1ConnectionString %>"
                        SelectCommand="sa_damage_id_list" SelectCommandType="StoredProcedure">
                        <SelectParameters>
